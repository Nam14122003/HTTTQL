  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setError(response.message || 'Có lỗi xảy ra khi tạo nhà cung cấp');
      }
    } catch (error) {
      setError(error.message || 'Có lỗi xảy ra khi tạo nhà cung cấp');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="mb-6">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold text-gray-800">Thêm nhà cung cấp mới</h1>
          </div>
          <p className="text-gray-600">Nhập thông tin chi tiết nhà cung cấp</p>
        </div>
